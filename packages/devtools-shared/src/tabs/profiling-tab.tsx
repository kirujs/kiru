...
import { kiruGlobal } from "../state.js"
...
function AppProfilingChart({ app: thisApp }: AppProfilingChartProps) {
  ...
  const chartHovered = signal(false)
  const lineChartData = signal<LineChartData>({
