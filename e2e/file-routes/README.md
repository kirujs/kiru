...
| [`e2e/file-routes-ssr`](../file-routes-ssr/) | SSR (`serverEntry` + Vite dev) | 5193 | `file-routes-ssr.cy.ts` (4 tests) |
...
Run from repo root: `node builderman.js test` (includes all three in the serial e2e pipeline).
