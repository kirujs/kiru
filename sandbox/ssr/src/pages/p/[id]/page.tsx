...
import { addComment, getPost } from "../../feed.remote.js"
...
export default function PostPage() {
  ...
  return ({ data, error }: PageProps<typeof load>) => {
    ...
    const p = data.post
    return (
      <article className="space-y-6" data-testid="post-page">
        <div>
        ...
        <section className="space-y-4">
          ...
          {ctx.user ? (
            ...
            >
              ...
              <Show when={commentForm.error}>
                <p className="text-sm text-rose-300">{commentForm.error}</p>
              </Show>
              <button
                type="submit"
