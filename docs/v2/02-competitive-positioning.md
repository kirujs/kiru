...
Codegen registry, `ActionFailure`, cookie specs on responses, `x-kiru-invalidate` for cache busting, and origin checks are **production-oriented** primitives (see [07-remote-actions.md](./07-remote-actions.md)).
